...
function ProductEditScreen() {
    ...
    // State fields matching products.py properties
    ...
    useEffect(() => {
        if (successUpdate) {
            ...
            // String conversion ensures '_id': "1" matches URL parameter id
            if (!product || !product.name || String(product._id) !== String(id)) {
